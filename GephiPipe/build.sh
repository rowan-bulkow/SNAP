...
#
# run - runs gephi-pipe.jar, requires input path, allows params: layout, modResolution
#   build.sh run inputPath [layout modResolution]
#
...
if [[ "$command" == "run" ]]; then
    ...
    run $input $layout $modResolution
